...
export async function getProductProfitPerformance(filters = {}) {
  ...
  console.log("🔥 DASHBOARD PROFIT deliveredOrders:", {
    count: deliveredOrders.length,
    revenue: deliveredOrders.reduce((s, o) => s + Number(o.price || 0), 0),
  ...
  console.log("🔥 DASHBOARD PROFIT dbOrdersByTracking:", {
    found: dbOrdersByTracking.size,
    keys: Array.from(dbOrdersByTracking.keys()),
  });
  ...
  // keep rest of your function same
  return [];
}
